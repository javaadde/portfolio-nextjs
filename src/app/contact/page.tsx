...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Using send instead of sendForm to ensure state data is captured correctly
  ...
  return (
    <div className="min-h-screen bg-[#FBF4E6] text-black">
      {/* Mobile Navigation */}
      <div
        className={`fixed text-[#FBF4E6] top-0 left-0 h-screen w-full bg-[#404CD6] shadow-2xl z-50 md:hidden transform transition-transform duration-300 ease-in-out ${openNav ? "translate-x-0" : "translate-x-full"}`}
      >
        <span
          onClick={() => setOpenNav(false)}
          className="text-2xl block text-center py-4 font-grotesk cursor-pointer"
        >
          Close
        </span>
        ...
        <div className="w-full pb-5 absolute bottom-0 flex justify-center">
          <div
            ...
            className="h-18 w-18 cursor-pointer font-jetbrains rounded-full bg-[#FBF4E6] text-center"
          >
            <p className="p-4 text-[#404CD6]">
              LETS,
              <br />
              TALK
            </p>
      ...
      <nav className="text-center p-4">
        ...
        <span
          ...
          className="text-2xl md:hidden font-semibold font-grotesk cursor-pointer"
        >
          Menu
        </span>
      </nav>
      ...
      >
        <p className="p-2.5 text-sm md:p-5 md:text-md">
          LETS,
          <br />
          TALK
        </p>
      ...
      <main className="flex flex-col items-center justify-center min-h-[80vh] px-6 md:px-12 py-20">
        <h1 className="text-5xl md:text-8xl font-bold font-grotesk mb-8 text-center">
          Get in Touch
        </h1>
        ...
        >
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-1">
              <label
                htmlFor="name"
                className="block font-jetbrains text-lg mb-2"
              >
                Name
              </label>
              <input
          ...
          <button
            ...
            className={`mt-8 self-center md:self-start px-8 py-3 bg-black text-[#FBF4E6] font-grotesk text-xl rounded-full transition-all duration-300 ${
              isSubmitting
        ...
        <div className="mt-20 flex flex-col items-center gap-4">
          ...
          <a
            href="mailto:jawaadde@gmail.com"
            className="font-grotesk text-2xl md:text-4xl hover:text-[#404CD6] transition-colors"
          >
            jawaadde@gmail.com
          </a>
        </div>
